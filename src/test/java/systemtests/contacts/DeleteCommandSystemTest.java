...
import static seedu.address.logic.commands.contacts.DeleteCommand.MESSAGE_DELETE_PERSON_SUCCESS;
...
public class DeleteCommandSystemTest extends ContactsSystemTest {
    ...
    public void delete() {
        ...
        String command = "     " + MODULE_WORD + " " + DeleteCommand.COMMAND_WORD + "      "
        ...
        command = MODULE_WORD + " " + DeleteCommand.COMMAND_WORD + " " + invalidIndex;
        ...
        command = MODULE_WORD + " " + DeleteCommand.COMMAND_WORD + " " + selectedIndex.getOneBased();
        ...
        command = MODULE_WORD + " " + DeleteCommand.COMMAND_WORD + " " + outOfBoundsIndex.getOneBased();
        assertCommandFailure(command, MESSAGE_INVALID_PERSON_DISPLAYED_INDEX);
    ...
    private void assertCommandSuccess(Index toDelete) {
        ...
        assertCommandSuccess(
                MODULE_WORD + " " + DeleteCommand.COMMAND_WORD + " " + toDelete.getOneBased(),
